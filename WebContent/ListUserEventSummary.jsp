...
<body>
      <div class="logo"><h1><a href="<c:url value='/' />">Catering Application</a></h1></div>
      <div class="menu_nav">
      </div>
	<div class="content">My Event Summary</div>
...
<input name="errMsg"  value="<c:out value='${errorMsgs}'/>" class="errorPane">
 ...
 <form action="<c:url value='EventController?action=listSpecificUserEvent' />" method="post">
