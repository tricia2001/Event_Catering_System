...
<link href="myStyle.css" rel="stylesheet" type="text/css" />
    <div class="header_resize">
	  ...
	  <div class="content">Modify User Profile</div>
      <div class="menu_nav">
      </div>
  </div>
...
<table>
  <tr>
   <td>
   <form name="register" action="<c:url value='/UserController?action=modifyUser' />" method="post">
   ...
   <input type="hidden" name="id" value="<c:out value='${selectedUser.utaId}'/>" >
    ...
    <input name="action" value="modifyUser" type="hidden">
	<br>
	<input type="submit" value="Modify" onclick="return updateconfirm()">

	
	</form>
	
<%-- Confirmation script for modify user. --%>
<script>
