...
<title>Update My User Profile</title>
</head>
<div class="header_resize">
      <div class="logo"><h1><a href="<c:url value='/' />">Campus Event Catering System</a></h1></div></div>
	  <div class="content">Update My User Profile</div>
	  <br>
<body>
...
<tr>
<td>
<form name="greetingForm" action="<c:url value='/UserController?action=updateUser' />" method="post" style="width: 300px; ">

  <input type="hidden" name="user1" value="<c:out value='${selectedUser.username}'/>" >
   <input type="hidden" name="id" value="<c:out value='${selectedUser.utaId}'/>" >
   <input type="hidden" name="role" value="<c:out value='${selectedUser.role}'/>" >
<table>
	...
	<input type="submit" value="Save" onclick="return updateconfirm()">
	


</form>

<%-- Confirmation script for modifying user profile. --%>
<script>
